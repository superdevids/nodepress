...
export function AdminHeader({ onMenuToggle }: AdminHeaderProps) {
  ...
  return (
    <header className="bg-card flex h-14 items-center gap-4 border-b px-6">
      {/* Hamburger menu */}
      <button
      ...
      <div className="relative hidden md:block">
        <input
          ...
          placeholder="Search..."
          className={cn(
            'border-input flex h-9 w-64 rounded-md border bg-transparent px-3 py-1 text-sm',
      ...
      <button
        onClick={() => {
          /* TODO: Open user profile dropdown/modal */
        }}
