...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Add New Post', href: '/admin/content/post/new' },
      { label: 'Add New Page', href: '/admin/content/page/new' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Permalinks', href: '/admin/settings/permalink' },
    ...
    >
      ...
      <div className="border-sidebar-border flex h-14 items-center border-b px-4">
        <Link href="/admin" className="flex items-center gap-2 font-bold">
          <span className="bg-primary text-primary-foreground flex h-7 w-7 items-center justify-center rounded text-xs font-bold">
            NP
          </span>
