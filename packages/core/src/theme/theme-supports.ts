...
export class ThemeSupportsManager {
    ...
    return [
      {
        ...
        effects: [
          'Shows featured image upload box in Content Editor',
          'Enables thumbnail size in media library',
        ],
      },
      {
      ...
      },
      {
        ...
        description: 'Let NodePress manage the document title',
      ...
      },
      {
        ...
        effects: [
          'Uses HTML5 comment list markup',
          'Uses HTML5 search form',
          'Uses HTML5 gallery markup',
        ],
      },
      {
        ...
        effects: [
          'Shows wide/full alignment buttons in Block Editor',
          'Adds alignwide and alignfull CSS classes',
        ],
      },
      {
        ...
        effects: [
          'Wraps oEmbed content in responsive container',
          'Prevents embeds from breaking layout',
        ],
      },
      {
        ...
        effects: [
          'Shows block style selector in editor sidebar',
          'Applies theme block styles to editor',
        ],
      },
      {
      ...
      },
      {
        ...
        effects: [
          'Shows gradient presets in color picker',
          'Enables gradient background on blocks',
        ],
      },
      {
        ...
        effects: [
          'Shows padding and margin controls in block settings',
          'Enables spacing presets from theme.json',
        ],
      },
      {
        ...
        effects: [
          'Shows unit selector (px, em, rem, %) in spacing controls',
      ...
      },
      {
        ...
        effects: [
          'Shows line-height input in block typography settings',
          'Allows fine-grained text spacing',
        ],
      },
      {
  ...
  async syncToDatabase(
    themeSlug: string,
    themeId: string,
    prisma: import('@nodepressjs/db').PrismaClient,
  ): Promise<void> {
