...
**Testing:** Jest + Playwright + Supertest (built-in configs)
...
| Forms Builder | 🔄 v2.0 | Drag-and-drop form builder. Conditional logic. Webhook submissions. |
...
| **Plugins / Extensions** | 60,000+ in official directory | ~50 (launch) — plugin SDK available |
| **Themes** | 10,000+ in official directory | ~30 (launch) — theme SDK available |
...
WordPress's ecosystem is its superpower. **60,000+ plugins** mean almost any feature is available as an off-the-shelf solution. NodePress cannot compete on ecosystem breadth at launch. The strategy is **quality over quantity**: fewer plugins but type-safe, sandboxed, and vetted. NodePress's plugin SDK lowers the bar for creating new extensions, which may accelerate ecosystem growth, but parity with WordPress's ecosystem maturity is a multi-year journey.
...
- **Rely on specific premium plugins/themes** — If you depend on Advanced Custom Fields Pro, Elementor Pro, Yoast SEO, WP Rocket, or similar, the cost of migrating may outweigh benefits.
...
|---|---|---|---|
| Ecosystem Maturity | High | 10/10 | 2/10 |
...
|---|---|
| [NodePress PRD v1.0](./docs/prd-v1.md) | Product Requirements Document — v1.0 scope |
| [NodePress PRD v2.0](./docs/prd-v2.md) | Product Requirements Document — v2.0 scope |
| [NodePress PRD v3.0](./docs/prd-v3.md) | Product Requirements Document — v3.0 scope |
| [NodePress Architecture](./docs/architecture.md) | System architecture documentation |
| [NodePress Plugin SDK](./docs/plugin-sdk.md) | Plugin development documentation |
| [NodePress Migration Guide](./docs/migration.md) | Detailed migration walkthrough |
...
*This document is maintained by the NodePress core team. Last updated: July 2026.*

*For questions, corrections, or additions, please open an issue or PR in the NodePress repository.*
